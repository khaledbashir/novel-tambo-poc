    ...
    onCreate() {
        ...
        if (this.editor) {
            ...
            try {
                ...
                // Add support for ai-highlight mark
                ...
                // Add support for italic mark (may use either "em" or "italic" as key)
                if (!marks["em"] && !marks["italic"]) {
                    marks["em"] = {
                        open: "*",
                        close: "*",
                        mixable: true,
                ...
                // Support both key names for italic
                if (!marks["italic"] && marks["em"]) {
            ...
            // Set up serializer with access to the schema-specific serializer
