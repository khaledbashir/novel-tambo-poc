...
> => ({
   ...
   */
  table: ({ children }) => (
    <div className="overflow-x-auto my-4 rounded-lg border border-border/50 bg-background">
   ...
   * Features bold text and distinct background with better contrast
   */
  th: ({ children }) => (
    <th className="border border-border/50 px-4 py-3 bg-muted/80 dark:bg-muted/60 font-semibold text-foreground text-left">
      {children}
    </th>
  ),
