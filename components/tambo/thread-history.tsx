    ...
    return (
      ...
      >
        <div
          ref={ref}
          className={cn(
            "border bg-card h-full transition-all duration-300 flex-shrink-0",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          `bg-card p-1 hover:bg-accent transition-colors rounded-md cursor-pointer absolute flex items-center justify-center`,
...
>(({ ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center rounded-md mb-4 hover:bg-accent transition-colors cursor-pointer relative",
  ...
  return (
    <div ref={ref} className={cn("mb-4 relative", className)} {...props}>
      ...
      <button
        ...
        className={cn(
          "p-1 hover:bg-accent rounded-md cursor-pointer absolute left-1/2 -translate-x-1/2",
          isCollapsed
      ...
      >
        ...
        <input
          ref={searchInputRef}
          type="text"
          className="pl-10 pr-4 py-2 w-full text-sm rounded-md bg-card border border-border focus:outline-none focus:ring-2 focus:ring-primary/50"
          placeholder="Search..."
          value={searchQuery}
  ...
  if (isLoading) {
    content = (
      <div
        ref={ref}
        className={cn(
          "text-sm text-muted-foreground p-2",
    ...
    content = (
      <div
        ref={ref}
        className={cn(
          "text-sm text-muted-foreground p-2 whitespace-nowrap",
          isCollapsed && "opacity-0 max-w-0 overflow-hidden pointer-events-none",
          className,
        )}
        {...props}
      ...
      <div className="space-y-1">
        {filteredThreads.map((thread: TamboThread) => (
          <div
            ...
            className={cn(
              "p-2 rounded-md hover:bg-accent cursor-pointer group flex items-center justify-between",
  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          className="p-1 hover:bg-accent rounded-md opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
          onClick={(e) => e.stopPropagation()}
        >
      ...
      <DropdownMenu.Portal>
        ...
        >
          <DropdownMenu.Item
            className="flex items-center gap-2 px-2 py-1.5 text-foreground hover:bg-accent rounded-sm cursor-pointer outline-none transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              onRename(thread);
            }}
