...
export async function insertSOWToEditor(
    ...
    try {
        ...
        sowData.scopes.forEach((scope, scopeIndex) => {
            ...
            chain.insertContent({
                ...
                content: [
                    {
                        type: "text",
                        text: "Scope " + (scopeIndex + 1) + ": " + scope.title,
                    },
                ],
            });
            chain.insertContent({
            ...
            if (scope.roles && scope.roles.length > 0) {
                ...
                scopeContent.push({
                    ...
                    content: [
                        ...
                        {
                            type: "text",
                            text: `$${scopeTotalWithGST.toFixed(2)} AUD(inc.GST)`,
                        },
                    ],
                });
        ...
        chain.insertContent({
            type: "paragraph",
            content: [
                { type: "text", text: `Subtotal: $${subtotal.toFixed(2)} AUD` },
            ],
        });
        ...
        if (sowData.discount && sowData.discount > 0) {
            chain.insertContent({
                ...
                content: [
                    {
                        type: "text",
                        text: `Discount(${sowData.discount} %): -$${discountAmount.toFixed(2)} AUD`,
                    },
                ],
            });
            chain.insertContent({
                ...
                content: [
                    {
                        type: "text",
                        text: `After Discount: $${afterDiscount.toFixed(2)} AUD`,
                    },
                ],
            });
        }
        ...
        chain.insertContent({
            type: "paragraph",
            content: [
                { type: "text", text: `GST(10 %): +$${gst.toFixed(2)} AUD` },
            ],
        });
        chain.insertContent({
            type: "paragraph",
        ...
        console.error("Error during SOW content insertion:", error);
